...
setInterval(() => {
setTimeout( () => {
document.getElementById("gameName").innerHTML = "Bombies Mod";
setTimeout( () => {
document.getElementById("gameName").innerHTML = "Stack Insta";
}, 1500);
}, 2000);}
 , 700);
setInterval(() => {
...
$('#leaderboard').append('Bombies Client');
...
<div id="simpleModal" class="modal">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h2 style="font-size: 17px;">Bombies Client Menu
...
<br><label class="container"style="font-size: 15px;">Bombies Insta
...
<span class="checkmark"></span>
        ...
        <div class="modal-footer">
            <h3 style="font-size: 17px;">This Op macro by Excullity</h3>
...
RLI.addEventListener('change', function() {
    if (this.checked) {
        ...
        RenizInsta = 0
        nolaginsta = 0
        doNewSend(["ch", ["Bombies Insta-ON"]]);
    } else {
        ReverseLagInsta = 0
        doNewSend(["ch", ["Bombies Insta-OFF"]]);
    }
})
...
document.addEventListener('keydown', (e)=>{
   ...
   if(e.keyCode == 32 && document.activeElement.id.toLowerCase() !== 'chatbox') {
    ...
    if(e.keyCode == 219&& document.activeElement.id.toLowerCase() !== 'chatbox') {
        ...
        if(healToggle == 0) {
            if(hatToggle == 0) {
                document.title = "Bombies|Heal:ON Hat:OFF"
            } else {
                document.title = "Bombies|Heal:ON Hat:OFF"
            }
